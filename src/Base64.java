...
public class Base64 {
	...
	public static byte[] decryptbase64(byte[] message) 
	{
		byte[] ret = null;
		try {
			ret = decode(message);
	...
	public static void main(String[] args) {
		...
		String b64helloString = encryptBase64(helloString.getBytes());
		System.out.println(b64helloString);
		System.out.println(new String(decryptbase64(b64helloString.getBytes())));
	}
